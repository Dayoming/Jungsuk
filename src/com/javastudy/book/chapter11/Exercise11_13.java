...
* 점수가 제일 높은 사람을 출력하는 코드이다. TreeMap의 정렬기준을 점수가 제일 높은 사람
* 부터 내림차순이 되도록 아래의 코드를 완성하시오.
* 단, 동점자 처리는 하지 않는다. */
    ...
    public static void main(String[] args) throws Exception {
        ...
        TreeMap rank = new TreeMap(new Comparator() {
            ...
            public int compare(Object o1, Object o2) {
                if (o1 instanceof SutdaDeck2 && o2 instanceof SutdaDeck2) {
                    Player player = (Player)o1;
                    Player player2 = (Player)o2;
                    return player2.point - player.point;
                }
                return -1;
            }
        });
