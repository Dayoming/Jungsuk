package com.javastudy.book.chapter11.Exercise_SungJuk;
...
public class Exercise11_20 {
	...
	*/
	    ...
	    try {
            ...
            System.out.println("유효한 값이 아닙니다. 다시 선택하여 주세요.");
            System.out.print("원하는 메뉴를 선택하세요.(1~3) : ");
            }
        } while (true);
	...
	*/
	...
	try {
	    ...
	    if (!input.equalsIgnoreCase("q")) { // 대소문자 관계 없이 검사
	        Scanner s2 = new Scanner(input).useDelimiter(",");
	        // Scanner의 기본 구분자는 " " 이나, userDelimiter를 사용하면 바꿀 수 있음
        ...
        System.out.println("입력 오류입니다. 이름, 반, 번호, 국어성적, 영어성적, 수학성적의 순서로" +
                "입력하세요.");
    }
